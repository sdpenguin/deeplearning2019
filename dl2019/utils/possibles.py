...
arg_list = {'evaluate': False, 'pca': False, 'model_denoise': 'baseline', 'model_desc': 'baseline', 'epochs_denoise': 10, 'epochs_desc': 10, 'nodisk': False, 'use_clean': False, 'denoise_suffix': None, 'desc_suffix': None, 'optimizer': 'default'}
