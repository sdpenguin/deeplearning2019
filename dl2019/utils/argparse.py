...
from dl2019.utils.possibles import possible_denoise_models, possible_desc_models
...
def parse_args():
    ...
    parser.add_argument('--model-denoise', dest='model_type_denoise', default='baseline', action='store', help='The model to run for the denoiser. Must be one of {}'.format(possible_denoise_models))
    parser.add_argument('--model-desc', dest='model_type_desc', default='baseline', action='store', help='The model to run for the descriptor. Must be one of {}'.format(possible_desc_models))
    ...
    if parsed.model_type_denoise not in possible_denoise_models:
    ...
    if parsed.model_type_desc not in possible_desc_models:
